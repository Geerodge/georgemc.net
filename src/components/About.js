        ...
        <AboutStyles>
            <div className="item-wrapper">
                <div className="item-wrapper__one">
                    ...
                    <p>I'm a New Zealand-born <span role="img" aria-label="New Zealand Flag">🇳🇿</span> digital marketing expert based in <span role="img" aria-label="United Kingdom Flag">🇬🇧</span> North Devon, UK.</p> 
                    <p><span className="highlight">I love to help people grow their businesses and projects</span>. I've been marketing, building websites and working in the IT industry for over 10 years <span role="img" aria-label="Nerd Face">🤓</span> <span role="img" aria-label="Thumb Up Sign">👍</span> </p>
